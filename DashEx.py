...
#note: there should be no space in the .py file name
#to run it on browser:
    #type "cd <py file directory path>" then enter
    #type "python <py file name>.py" then enter
    #copy paste the URL given in the browser
#can also copy paste URL from the spyder console